...
var imageOptimizer=function(){var e=[].slice.call(document.querySelectorAll("img.lazy"));if("IntersectionObserver"in window){config={rootMargin:"250px 0px"};var i=new IntersectionObserver(function(e,r){e.forEach(function(e){if(e.isIntersecting){var r=e.target;r.src=r.dataset.src,$lazyImage=$(r),$lazyImage.removeClass("blur"),i.unobserve(r)}})},config);e.forEach(function(e){i.observe(e)})}else e.forEach(function(e){e.src=e.dataset.src})};imageOptimizer();
