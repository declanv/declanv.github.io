...
$(document).ready(function(){mobileMenuOpen=!1;var n=function(){console.log("mobile menu click triggered. Is the #menu around? ",$("#menu").length),$("#menu").on("click",function(){console.log("menu is clicked"),$(this).addClass("touched"),$(".site-header").toggleClass("open-mobile"),console.log("here is the mobileMenuOpen value: ",mobileMenuOpen),mobileMenuOpen?mobileMenuOpen=!1:mobileMenuOpen=!0}),$(".subpages").siblings(".page-link").on("click",function(e){e.preventDefault(),$(this).addClass("selected"),$(".trigger.box").addClass("subnav-open"),$(this).siblings(".subpages").addClass("open"),$(this).siblings(".subpages").removeClass("closing-subnav")})};var o=!1;window.addEventListener("scroll",function(e){window.scrollY,o||(window.requestAnimationFrame(function(){t(),i(),o=!1}),o=!0)});window.requestAnimationFrame;function t(){document.querySelectorAll(".show-on-scroll").forEach(function(e){(function(e){"undefined"!=typeof jQuery&&e instanceof jQuery&&(e=e[0]);var n=e.getBoundingClientRect(),o=window.innerHeight||document.documentElement.clientHeight,t=window.innerWidth||document.documentElement.clientWidth;return 0<=n.left&&0<=n.top&&n.left+n.width/2.75<=t&&n.top+n.height/2.75<=o})(e)&&(e.classList.add("visible"),e.classList.add("play"))})}function i(){$(window).scrollTop()>2*$(".site-header").outerHeight()?($("header").addClass("scroll-away"),$("header").removeClass("scroll-in"),$("header").removeClass("initial")):$(window).scrollTop()<=2*$(".site-header").outerHeight()&&!$(".siteheader").hasClass("initial")&&($("header").removeClass("scroll-away"),$("header").addClass("scroll-in")),$(".page-nav.next").length&&$(window).scrollTop()+$(window).height()>$(document).height()-300?(console.log("you're at the bottom of the page"),$(".page-nav.next").addClass("open")):$(".page-nav.next").length&&$(window).scrollTop()+$(window).height()<$(document).height()-300&&$(".page-nav.next").removeClass("open")}var a=function(e){console.log("init photo swipe is actually happening");var n=function(e){console.log("in onthumbnails click"),(e=e||window.event).preventDefault?e.preventDefault():e.returnValue=!1;var n=function e(n,o){return n&&(o(n)?n:e(n.parentNode,o))}(e.target||e.srcElement,function(e){return e.tagName&&"FIGURE"===e.tagName.toUpperCase()});if(n){for(var o,t=n.parentNode,i=n.parentNode.childNodes,a=i.length,l=0,s=0;s<a;s++)if(1===i[s].nodeType){if(i[s]===n){o=l;break}l++}return 0<=o&&(console.log("open photoswipe bc valid index found"),r(o,t)),!1}},r=function(e,n,o,t){console.log("open photoswipe is actually happening");var i,a,l,s=document.querySelectorAll(".pswp")[0];if(l=function(e){for(var n,o,t,i,a=e.childNodes,l=a.length,s=[],r=0;r<l;r++)1===(n=a[r]).nodeType&&(t=(o=n.children[0]).getAttribute("data-size").split("x"),i={src:o.getAttribute("href"),w:parseInt(t[0],10),h:parseInt(t[1],10)},1<n.children.length&&(i.title=n.children[1].innerHTML),0<o.children.length&&(i.msrc=o.children[0].getAttribute("src")),i.el=n,s.push(i));return s}(n),a={galleryUID:n.getAttribute("data-pswp-uid"),getThumbBoundsFn:function(e){var n=l[e].el.getElementsByTagName("img")[0],o=window.pageYOffset||document.documentElement.scrollTop,t=n.getBoundingClientRect();return{x:t.left,y:t.top+o,w:t.width}}},t)if(a.galleryPIDs){for(var r=0;r<l.length;r++)if(l[r].pid==e){a.index=r;break}}else a.index=parseInt(e,10)-1;else a.index=parseInt(e,10);isNaN(a.index)||(o&&(a.showAnimationDuration=0),console.log("photoswipe, here is the element ",s,"here are the items: ",l,"here are the options: ",a),i=new PhotoSwipe(s,PhotoSwipeUI_Default,l,a),console.log("here is the gallery: ",i),i.init())},o=document.querySelectorAll(e);console.log("here are the galleryElements",o);for(var t=0,i=o.length;t<i;t++)o[t].setAttribute("data-pswp-uid",t+1),o[t].onclick=n;var a=function(){var e=window.location.hash.substring(1),n={};if(e.length<5)return n;for(var o=e.split("&"),t=0;t<o.length;t++)if(o[t]){var i=o[t].split("=");i.length<2||(n[i[0]]=i[1])}return n.gid&&(n.gid=parseInt(n.gid,10)),n}();a.pid&&a.gid&&r(a.pid,o[a.gid-1],!0,!0)},l=$("#transition-shape");defaultTransitionColor="#ffffff",currentTransitionColor=defaultTransitionColor,Barba.Dispatcher.on("linkClicked",function(e){currentTransitionColor=defaultTransitionColor,console.log("here is the el being clicked: ",e),null!==e.dataset.hex&&void 0!==e.dataset.hex?currentTransitionColor=e.dataset.hex:currentTransitionColor=defaultTransitionColor});var e=Barba.BaseTransition.extend({start:function(){Promise.all([this.newContainerLoading,this.fadeOut()]).then(this.fadeIn.bind(this))},fadeOut:function(){return console.log("here is what the background color will look like: ","#"+currentTransitionColor),l.removeClass("transition-out"),l.addClass("transition-in"),l.css("background-color","#"+currentTransitionColor),$(this.oldContainer).animate({opacity:0},800,function(){}).promise()},fadeIn:function(){var e=this,n=$(this.newContainer);$(this.oldContainer).hide(),$(window).scrollTop(0),i(),l.removeClass("transition-in"),l.addClass("transition-out"),n.css({visibility:"visible",opacity:0}),n.animate({opacity:1},800,function(){e.done(function(){})})},finish:function(){}});Barba.Pjax.getTransition=function(){return console.log("in transition"),e},Barba.Dispatcher.on("newPageReady",function(){t(),i(),s(this.namespace)});var s=function(e){$("body").removeClass(),$("body").addClass(e),console.log("body link updated to: ",e)},r=Barba.BaseView.extend({namespace:"home",onEnter:function(){console.log("alright, the homepage view is ready"),s(this.namespace)},onEnterCompleted:function(e){console.log("alright, the homepage view enter has completed. here is the namespace: ",this.namespace),n()},onLeave:function(){console.log("alright, we are leaving the homepage view")},onLeaveCompleted:function(){}}),c=Barba.BaseView.extend({namespace:"about",onEnter:function(){console.log("alright, the about view is ready"),s(this.namespace)},onEnterCompleted:function(){console.log("alright, the about view enter has completed"),n()},onLeave:function(){console.log("alright, we are leaving the about view")},onLeaveCompleted:function(){}}),d=Barba.BaseView.extend({namespace:"web",onEnter:function(){console.log("alright, the web view is ready"),s(this.namespace)},onEnterCompleted:function(){console.log("alright, the web view enter has completed"),n()},onLeave:function(){console.log("alright, we are leaving the web view")},onLeaveCompleted:function(){}}),g=Barba.BaseView.extend({namespace:"photo",onEnter:function(){console.log("alright, the photo view is ready"),s(this.namespace)},onEnterCompleted:function(){console.log("alright, the photo view enter has completed"),n()},onLeave:function(){console.log("alright, we are leaving the photo view")},onLeaveCompleted:function(){}}),h=Barba.BaseView.extend({namespace:"art",onEnter:function(){console.log("alright, the art view is ready"),s(this.namespace),console.log("here is what the body currently looks like: ",$("body"))},onEnterCompleted:function(){console.log("alright, the art view enter has completed"),console.log("here is the namespace",this.namespace),$(".grid").imagesLoaded().done(function(e){console.log("all images successfully loaded")}).always(function(e){console.log("all images loaded"),a(".projects-container"),$(".grid").masonry({percentPosition:!0,gutter:30})}).fail(function(){console.log("all images loaded, at least one is broken")}).progress(function(e,n){var o=n.isLoaded?"loaded":"broken";console.log("image is "+o+" for "+n.img.src)}),n()},onLeave:function(){console.log("alright, we are leaving the art view")},onLeaveCompleted:function(){}}),u=Barba.BaseView.extend({namespace:"illustration",onEnter:function(){console.log("alright, the illustration view is ready"),s(this.namespace),console.log("here is what the body currently looks like: ",$("body"))},onEnterCompleted:function(){console.log("alright, the illustration view enter has completed"),console.log("here is the namespace",this.namespace),$(".grid").imagesLoaded().done(function(e){console.log("all images successfully loaded")}).always(function(e){console.log("all images loaded"),a(".projects-container"),$(".grid").masonry({percentPosition:!0,gutter:30})}).fail(function(){console.log("all images loaded, at least one is broken")}).progress(function(e,n){var o=n.isLoaded?"loaded":"broken";console.log("image is "+o+" for "+n.img.src)}),n()},onLeave:function(){console.log("alright, we are leaving the illustration view")},onLeaveCompleted:function(){}}),p=Barba.BaseView.extend({namespace:"figuredrawings",onEnter:function(){console.log("alright, the figureDrawings view is ready"),s(this.namespace),console.log("here is what the body currently looks like: ",$("body"))},onEnterCompleted:function(){console.log("alright, the figureDrawings view enter has completed"),console.log("here is the namespace",this.namespace),$(".grid").imagesLoaded().done(function(e){console.log("all images successfully loaded")}).always(function(e){console.log("all images loaded"),a(".projects-container"),$(".grid").masonry({percentPosition:!0,gutter:30})}).fail(function(){console.log("all images loaded, at least one is broken")}).progress(function(e,n){var o=n.isLoaded?"loaded":"broken";console.log("image is "+o+" for "+n.img.src)}),n()},onLeave:function(){console.log("alright, we are leaving the figureDrawings view")},onLeaveCompleted:function(){}});r.init(),h.init(),u.init(),p.init(),d.init(),g.init(),c.init(),Barba.Pjax.start()});