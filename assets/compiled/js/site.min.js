...
$(document).ready(function(){mobileMenuOpen=!1;var n=!1;window.addEventListener("scroll",function(e){window.scrollY,n||(window.requestAnimationFrame(function(){document.querySelectorAll(".show-on-scroll").forEach(function(e){(function(e){"undefined"!=typeof jQuery&&e instanceof jQuery&&(e=e[0]);var n=e.getBoundingClientRect(),t=window.innerHeight||document.documentElement.clientHeight,o=window.innerWidth||document.documentElement.clientWidth;return 0<=n.left&&0<=n.top&&n.left+n.width/2.75<=o&&n.top+n.height/2.75<=t})(e)&&(e.classList.add("visible"),e.classList.add("play"))}),function(){$(window).scrollTop()>2*$(".site-header").outerHeight()?($("header").addClass("scroll-away"),$("header").removeClass("scroll-in"),$("header").removeClass("initial")):$(window).scrollTop()<=2*$(".site-header").outerHeight()&&!$(".siteheader").hasClass("initial")&&($("header").removeClass("scroll-away"),$("header").addClass("scroll-in"));$(".page-nav.next").length&&$(window).scrollTop()+$(window).height()>$(document).height()-300?(console.log("you're at the bottom of the page"),$(".page-nav.next").addClass("open")):$(".page-nav.next").length&&$(window).scrollTop()+$(window).height()<$(document).height()-300&&$(".page-nav.next").removeClass("open")}(),n=!1}),n=!0)});window.requestAnimationFrame;var t=function(e){console.log("init photo swipe is actually happening");var n=function(e){console.log("in onthumbnails click"),(e=e||window.event).preventDefault?e.preventDefault():e.returnValue=!1;var n=function e(n,t){return n&&(t(n)?n:e(n.parentNode,t))}(e.target||e.srcElement,function(e){return e.tagName&&"FIGURE"===e.tagName.toUpperCase()});if(n){for(var t,o=n.parentNode,i=n.parentNode.childNodes,l=i.length,r=0,a=0;a<l;a++)if(1===i[a].nodeType){if(i[a]===n){t=r;break}r++}return 0<=t&&(console.log("open photoswipe bc valid index found"),s(t,o)),!1}},s=function(e,n,t,o){console.log("open photoswipe is actually happening");var i,l,r,a=document.querySelectorAll(".pswp")[0];if(r=function(e){for(var n,t,o,i,l=e.childNodes,r=l.length,a=[],s=0;s<r;s++)1===(n=l[s]).nodeType&&(o=(t=n.children[0]).getAttribute("data-size").split("x"),i={src:t.getAttribute("href"),w:parseInt(o[0],10),h:parseInt(o[1],10)},1<n.children.length&&(i.title=n.children[1].innerHTML),0<t.children.length&&(i.msrc=t.children[0].getAttribute("src")),i.el=n,a.push(i));return a}(n),l={galleryUID:n.getAttribute("data-pswp-uid"),getThumbBoundsFn:function(e){var n=r[e].el.getElementsByTagName("img")[0],t=window.pageYOffset||document.documentElement.scrollTop,o=n.getBoundingClientRect();return{x:o.left,y:o.top+t,w:o.width}}},o)if(l.galleryPIDs){for(var s=0;s<r.length;s++)if(r[s].pid==e){l.index=s;break}}else l.index=parseInt(e,10)-1;else l.index=parseInt(e,10);isNaN(l.index)||(t&&(l.showAnimationDuration=0),console.log("photoswipe, here is the element ",a,"here are the items: ",r,"here are the options: ",l),i=new PhotoSwipe(a,PhotoSwipeUI_Default,r,l),console.log("here is the gallery: ",i),i.init())},t=document.querySelectorAll(e);console.log("here are the galleryElements",t);for(var o=0,i=t.length;o<i;o++)t[o].setAttribute("data-pswp-uid",o+1),t[o].onclick=n;var l=function(){var e=window.location.hash.substring(1),n={};if(e.length<5)return n;for(var t=e.split("&"),o=0;o<t.length;o++)if(t[o]){var i=t[o].split("=");i.length<2||(n[i[0]]=i[1])}return n.gid&&(n.gid=parseInt(n.gid,10)),n}();l.pid&&l.gid&&s(l.pid,t[l.gid-1],!0,!0)};$(".grid").imagesLoaded().done(function(e){console.log("all images successfully loaded"),t(".projects-container"),$(".grid").masonry({percentPosition:!0,gutter:30})}).always(function(e){console.log("all images loaded")}).fail(function(){console.log("all images loaded, at least one is broken")}).progress(function(e,n){var t=n.isLoaded?"loaded":"broken";console.log("image is "+t+" for "+n.img.src)})});