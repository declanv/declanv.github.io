...
var imageOptimizer=function(e,o){void 0!==typeof e&&null!==e||(e=".grid");var i=document.querySelector(e);console.log("here is the container: ",i);var n,t,r,a,s=[].slice.call(i.querySelectorAll("img.lazy")),c=function(){config={rootMargin:"250px 0px"};var r=new IntersectionObserver(function(e,n){e.forEach(function(e){if(e.isIntersecting&&0<e.intersectionRatio){var n=e.target,t=new Image;t.onload=function(){n.src=this.src,$lazyImage=$(n),$lazyImage.removeClass("blur"),n.classList.add("unblur"),null!==o&&void 0!==typeof o&&$(i).masonry("layout")},t.src=n.dataset.src,r.unobserve(n)}})},config);s.forEach(function(e){r.observe(e)})};if("IntersectionObserver"in window)c();else{n="/assets/compiled/js/intersectionObserverPolyfill.js",t=c,r=document.head,(a=document.createElement("script")).type="text/javascript",a.src=n,a.onreadystatechange=t,a.onload=t,r.appendChild(a)}};
!function(){for(var o=0,e=["webkit","moz"],n=0;n<e.length&&!window.requestAnimationFrame;++n)window.requestAnimationFrame=window[e[n]+"RequestAnimationFrame"],window.cancelAnimationFrame=window[e[n]+"CancelAnimationFrame"]||window[e[n]+"CancelRequestAnimationFrame"];window.requestAnimationFrame||(window.requestAnimationFrame=function(e,n){var t=(new Date).getTime(),i=Math.max(0,16-(t-o)),a=window.setTimeout(function(){e(t+i)},i);return o=t+i,a}),window.cancelAnimationFrame||(window.cancelAnimationFrame=function(e){clearTimeout(e)})}(),$(document).ready(function(){var t=function(){var e=$(".subpages").prev(".page-link"),n=e.siblings(".subpages");e.find(".page-link").removeClass("selected"),$(".trigger.box").removeClass("subnav-open"),n.removeClass("open")};mobileMenuOpen=!1;var i=function(){mobileMenuOpen=!1,$(".site-header").removeClass("open-mobile"),t()},a=function(){$("#menu").on("click",function(){mobileMenuOpen?i():(mobileMenuOpen=!0,$(".site-header").addClass("open-mobile"),$(this).addClass("touched"))});var n=function(e){if(e.hasClass("selected"));else{e.addClass("selected"),$(".trigger.box").addClass("subnav-open");var n=e.siblings(".subpages");$(".subpages").not(n).removeClass("open"),$(".page-link").not(e).removeClass("selected"),n.addClass("open")}$(document).on("click.document",function(e){if($(window).width()<=600&&mobileMenuOpen){var n=$(".subpages").prev(".page-link");n.is(e.target)||0!==n.has(e.target).length||$("#menu").is(e.target)||t()}})};$(".page-link, .site-title").on("click",function(e){window.innerWidth<600&&0<$(this).siblings(".subpages").length?$(this).hasClass("selected")||(e.preventDefault(),e.stopImmediatePropagation(),n($(this))):i()})};var n=!1;window.addEventListener("scroll",function(e){window.scrollY,n||(window.requestAnimationFrame(function(){document.querySelectorAll(".show-on-scroll").forEach(function(e){(function(e){"undefined"!=typeof jQuery&&e instanceof jQuery&&(e=e[0]);var n=e.getBoundingClientRect(),t=window.innerHeight||document.documentElement.clientHeight,i=window.innerWidth||document.documentElement.clientWidth;return 0<=n.left&&0<=n.top&&n.left+n.width/2.75<=i&&n.top+n.height/2.75<=t})(e)&&(e.classList.add("visible"),e.classList.add("play"))}),o(),n=!1}),n=!0)});window.requestAnimationFrame;function o(){$(window).scrollTop()>$(".site-header").outerHeight()/2?($("header").addClass("scroll-away"),$("header").removeClass("scroll-in"),$("header").removeClass("initial")):$(window).scrollTop()<=2*$(".site-header").outerHeight()&&!$(".siteheader").hasClass("initial")&&($("header").removeClass("scroll-away"),$("header").addClass("scroll-in")),$(".page-nav.next").length&&$(window).scrollTop()+$(window).height()>$(document).height()-300?$(".page-nav.next").addClass("open"):$(".page-nav.next").length&&$(window).scrollTop()+$(window).height()<$(document).height()-300&&$(".page-nav.next").removeClass("open")}var r=function(e){for(var n=function(e){(e=e||window.event).preventDefault?e.preventDefault():e.returnValue=!1;var n=e.target||e.srcElement,t=function e(n,t){return n&&(t(n)?n:e(n.parentNode,t))}(n,function(e){return e.tagName&&"FIGURE"===e.tagName.toUpperCase()&&"project-link-text"!==n.className});if(t){for(var i,a=t.parentNode,o=t.parentNode.childNodes,r=o.length,s=0,l=0;l<r;l++)if(1===o[l].nodeType){if(o[l]===t){i=s;break}s++}return 0<=i&&d(i,a),!1}},d=function(e,n,t,i){var a,o,r=document.querySelectorAll(".pswp")[0];if(o=function(e){for(var n,t,i,a,o=e.childNodes,r=o.length,s=[],l=0;l<r;l++)1===(n=o[l]).nodeType&&(i=(t=n.children[0]).getAttribute("data-size").split("x"),a={src:t.getAttribute("href"),w:parseInt(i[0],10),h:parseInt(i[1],10)},1<n.children.length&&(a.title=n.children[1].innerHTML),0<t.children.length&&(a.msrc=t.children[0].getAttribute("src")),a.el=n,s.push(a));return s}(n),a={spacing:0,galleryUID:n.getAttribute("data-pswp-uid"),getThumbBoundsFn:function(e){var n=o[e].el.getElementsByTagName("img")[0],t=window.pageYOffset||document.documentElement.scrollTop,i=n.getBoundingClientRect();return{x:i.left,y:i.top+t,w:i.width}}},i)if(a.galleryPIDs){for(var s=0;s<o.length;s++)if(o[s].pid==e){a.index=s;break}}else a.index=parseInt(e,10)-1;else a.index=parseInt(e,10);isNaN(a.index)||(t&&(a.showAnimationDuration=0),new PhotoSwipe(r,PhotoSwipeUI_Default,o,a).init())},t=document.querySelectorAll(e),i=0,a=t.length;i<a;i++)t[i].setAttribute("data-pswp-uid",i+1),t[i].onclick=n;var o=function(){var e=window.location.hash.substring(1),n={};if(e.length<5)return n;for(var t=e.split("&"),i=0;i<t.length;i++)if(t[i]){var a=t[i].split("=");a.length<2||(n[a[0]]=a[1])}return n.gid&&(n.gid=parseInt(n.gid,10)),n}();o.pid&&o.gid&&d(o.pid,t[o.gid-1],!0,!0)},s=$("#transition-shape");defaultTransitionColor="#ffffff",currentTransitionColor=defaultTransitionColor,Barba.Dispatcher.on("linkClicked",function(e){currentTransitionColor=defaultTransitionColor,null!==e.dataset.hex&&void 0!==e.dataset.hex?currentTransitionColor=e.dataset.hex:currentTransitionColor=defaultTransitionColor});var e=Barba.BaseTransition.extend({start:function(){Promise.all([this.newContainerLoading,this.fadeOut()]).then(this.fadeIn.bind(this))},fadeOut:function(){return s.removeClass("transition-out"),s.addClass("transition-in"),s.css("background-color","#"+currentTransitionColor),$(this.oldContainer).animate({opacity:0},200,function(){}).promise().then(function(){l()})},fadeIn:function(){var e=this,n=$(this.newContainer);d(),$(this.oldContainer).hide(),$(window).scrollTop(0),o(),s.removeClass("transition-in"),s.addClass("transition-out"),n.css({visibility:"visible",opacity:0}),n.animate({opacity:1},400,function(){e.done(function(){})})},finish:function(){}});Barba.Pjax.getTransition=function(){return e};previousBodyClass="";var l=function(){$("body").removeClass(previousBodyClass)},d=function(){$("body").addClass(currentBodyClass)};$.each([{parent:"home",namespace:"home",notGridLayout:!0},{parent:"web",namespace:"web",notGridLayout:!0},{parent:"art",namespace:"art"},{parent:"art",namespace:"figure-drawings"},{parent:"art",namespace:"illustration"},{parent:"photo",namespace:"photo"},{parent:"photo",namespace:"holga"},{parent:"photo",namespace:"editorial"},{parent:"photo",namespace:"other"},{parent:"about",namespace:"about",notGridLayout:!0}],function(e,n){if(void 0===n.notGridLayout)var t=!1;else t=!0;!function(e,n,t){n.replace(/-([a-z])/g,function(e){return e[1].toUpperCase()});var i=n.replace(/-/g," ");$(".grid");(n=Barba.BaseView.extend({namespace:i,onEnter:function(){currentBodyClass=e,d()},onEnterCompleted:function(){a(),t?imageOptimizer(".content",null):$(".grid").imagesLoaded().done(function(e){$(".grid").addClass("fade-in-grid"),$(".section-title").addClass("loaded")}).always(function(e){var a=$(".grid");$.each(a,function(e,n){var t="gallery-"+(e+1),i=$(".grid").masonry({percentPosition:!0});1<a.length?(console.log("here is the galleryNameString: ","."+t),imageOptimizer("."+t,i)):imageOptimizer(".grid",i),r(".projects-container")})}).fail(function(){}).progress(function(e,n){n.isLoaded})},onLeave:function(){previousBodyClass=e,$("#menu").removeClass("touched"),mobileMenuOpen=!1},onLeaveCompleted:function(){}})).init()}(n.parent,n.namespace,t)}),Barba.Pjax.start()});