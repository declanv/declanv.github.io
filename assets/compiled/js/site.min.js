...
$(function(){var e=[].slice.call(document.querySelectorAll("img.lazy"));if(console.log("here are the lazyImages: ",e),"IntersectionObserver"in window){console.log("the intersection observer check works"),config={rootMargin:"250px 0px"};var n=new IntersectionObserver(function(e,t){e.forEach(function(e){if(e.isIntersecting){var t=e.target;t.src=t.dataset.src,$lazyImage=$(t),$lazyImage.parent().addClass("unblur"),n.unobserve(t)}})},config);e.forEach(function(e){n.observe(e)})}else e.forEach(function(e){e.src=e.dataset.src});!function(e){for(var t=function(e){(e=e||window.event).preventDefault?e.preventDefault():e.returnValue=!1;var t=function e(t,n){return t&&(n(t)?t:e(t.parentNode,n))}(e.target||e.srcElement,function(e){return e.tagName&&"FIGURE"===e.tagName.toUpperCase()});if(t){for(var n,r=t.parentNode,i=t.parentNode.childNodes,o=i.length,l=0,a=0;a<o;a++)if(1===i[a].nodeType){if(i[a]===t){n=l;break}l++}return 0<=n&&s(n,r),!1}},s=function(e,t,n,r){console.log("open photoswipe is firing");var i,o,l,a=document.querySelectorAll(".pswp")[0];if(l=function(e){for(var t,n,r,i,o=e.childNodes,l=o.length,a=[],s=0;s<l;s++)t=o[s],console.log("here is the figureEl",t),1===t.nodeType&&(n=t.children[0],console.log("here is the linkEl: ",n),r=n.getAttribute("data-size").split("x"),i={src:n.getAttribute("href"),w:parseInt(r[0],10),h:parseInt(r[1],10)},1<t.children.length&&(i.title=t.children[1].innerHTML),0<n.children.length&&(i.msrc=n.children[0].getAttribute("src")),i.el=t,a.push(i));return a}(t),o={galleryUID:t.getAttribute("data-pswp-uid"),getThumbBoundsFn:function(e){var t=l[e].el.getElementsByTagName("img")[0],n=window.pageYOffset||document.documentElement.scrollTop,r=t.getBoundingClientRect();return{x:r.left,y:r.top+n,w:r.width}}},r)if(o.galleryPIDs){for(var s=0;s<l.length;s++)if(l[s].pid==e){o.index=s;break}}else o.index=parseInt(e,10)-1;else o.index=parseInt(e,10);isNaN(o.index)||(n&&(o.showAnimationDuration=0),(i=new PhotoSwipe(a,PhotoSwipeUI_Default,l,o)).listen("gettingData",function(e,t){console.log("okay, i'm inside the gallery listen function"),0===e&&(console.log("here is the item in the gallery listen function:",t),t.html="<div>Dynamically generated HTML "+Math.random()+"</div>")}),i.init())},n=document.querySelectorAll(e),r=0,i=n.length;r<i;r++)n[r].setAttribute("data-pswp-uid",r+1),n[r].onclick=t;var o=function(){var e=window.location.hash.substring(1),t={};if(e.length<5)return t;for(var n=e.split("&"),r=0;r<n.length;r++)if(n[r]){var i=n[r].split("=");i.length<2||(t[i[0]]=i[1])}return t.gid&&(t.gid=parseInt(t.gid,10)),t}();o.pid&&o.gid&&s(o.pid,n[o.gid-1],!0,!0)}(".projects-container")});
$(function(){$(".grid").masonry({percentPosition:!0,fitWidth:!0,gutter:0})});

$(document).ready(function(){mobileMenuOpen=!1;var o=function(){console.log("mobile menu click triggered. Is the #menu around? ",$("#menu").length),$("#menu").on("click",function(){console.log("menu is clicked"),$(this).addClass("touched"),$(".site-header").toggleClass("open-mobile"),console.log("here is the mobileMenuOpen value: ",mobileMenuOpen),mobileMenuOpen?mobileMenuOpen=!1:mobileMenuOpen=!0}),$(".subpages").siblings(".page-link").on("click",function(e){e.preventDefault(),$(this).addClass("selected"),$(".trigger.box").addClass("subnav-open"),$(this).siblings(".subpages").addClass("open"),$(this).siblings(".subpages").removeClass("closing-subnav")})};var n=!1;window.addEventListener("scroll",function(e){window.scrollY,n||(window.requestAnimationFrame(function(){t(),i(),n=!1}),n=!0)});window.requestAnimationFrame;function t(){document.querySelectorAll(".show-on-scroll").forEach(function(e){(function(e){"undefined"!=typeof jQuery&&e instanceof jQuery&&(e=e[0]);var o=e.getBoundingClientRect(),n=window.innerHeight||document.documentElement.clientHeight,t=window.innerWidth||document.documentElement.clientWidth;return 0<=o.left&&0<=o.top&&o.left+o.width/2.75<=t&&o.top+o.height/2.75<=n})(e)&&(e.classList.add("visible"),e.classList.add("play"))})}function i(){$(window).scrollTop()>2*$(".site-header").outerHeight()?($("header").addClass("scroll-away"),$("header").removeClass("scroll-in"),$("header").removeClass("initial")):$(window).scrollTop()<=2*$(".site-header").outerHeight()&&!$(".siteheader").hasClass("initial")&&($("header").removeClass("scroll-away"),$("header").addClass("scroll-in")),$(".page-nav.next").length&&$(window).scrollTop()+$(window).height()>$(document).height()-300?(console.log("you're at the bottom of the page"),$(".page-nav.next").addClass("open")):$(".page-nav.next").length&&$(window).scrollTop()+$(window).height()<$(document).height()-300&&$(".page-nav.next").removeClass("open")}var a=function(e){console.log("init photo swipe is actually happening");var o=function(e){console.log("in onthumbnails click"),(e=e||window.event).preventDefault?e.preventDefault():e.returnValue=!1;var o=function e(o,n){return o&&(n(o)?o:e(o.parentNode,n))}(e.target||e.srcElement,function(e){return e.tagName&&"FIGURE"===e.tagName.toUpperCase()});if(o){for(var n,t=o.parentNode,i=o.parentNode.childNodes,a=i.length,l=0,s=0;s<a;s++)if(1===i[s].nodeType){if(i[s]===o){n=l;break}l++}return 0<=n&&(console.log("open photoswipe bc valid index found"),r(n,t)),!1}},r=function(e,o,n,t){console.log("open photoswipe is actually happening");var i,a,l,s=document.querySelectorAll(".pswp")[0];if(l=function(e){for(var o,n,t,i,a=e.childNodes,l=a.length,s=[],r=0;r<l;r++)1===(o=a[r]).nodeType&&(t=(n=o.children[0]).getAttribute("data-size").split("x"),i={src:n.getAttribute("href"),w:parseInt(t[0],10),h:parseInt(t[1],10)},1<o.children.length&&(i.title=o.children[1].innerHTML),0<n.children.length&&(i.msrc=n.children[0].getAttribute("src")),i.el=o,s.push(i));return s}(o),a={galleryUID:o.getAttribute("data-pswp-uid"),getThumbBoundsFn:function(e){var o=l[e].el.getElementsByTagName("img")[0],n=window.pageYOffset||document.documentElement.scrollTop,t=o.getBoundingClientRect();return{x:t.left,y:t.top+n,w:t.width}}},t)if(a.galleryPIDs){for(var r=0;r<l.length;r++)if(l[r].pid==e){a.index=r;break}}else a.index=parseInt(e,10)-1;else a.index=parseInt(e,10);isNaN(a.index)||(n&&(a.showAnimationDuration=0),console.log("photoswipe, here is the element ",s,"here are the items: ",l,"here are the options: ",a),i=new PhotoSwipe(s,PhotoSwipeUI_Default,l,a),console.log("here is the gallery: ",i),i.init())},n=document.querySelectorAll(e);console.log("here are the galleryElements",n);for(var t=0,i=n.length;t<i;t++)n[t].setAttribute("data-pswp-uid",t+1),n[t].onclick=o;var a=function(){var e=window.location.hash.substring(1),o={};if(e.length<5)return o;for(var n=e.split("&"),t=0;t<n.length;t++)if(n[t]){var i=n[t].split("=");i.length<2||(o[i[0]]=i[1])}return o.gid&&(o.gid=parseInt(o.gid,10)),o}();a.pid&&a.gid&&r(a.pid,n[a.gid-1],!0,!0)},l=$("#transition-shape");defaultTransitionColor="#ffffff",currentTransitionColor=defaultTransitionColor,Barba.Dispatcher.on("linkClicked",function(e){currentTransitionColor=defaultTransitionColor,console.log("here is the el being clicked: ",e),null!==e.dataset.hex&&void 0!==e.dataset.hex?currentTransitionColor=e.dataset.hex:currentTransitionColor=defaultTransitionColor});var e=Barba.BaseTransition.extend({start:function(){Promise.all([this.newContainerLoading,this.fadeOut()]).then(this.fadeIn.bind(this))},fadeOut:function(){return console.log("here is what the background color will look like: ","#"+currentTransitionColor),l.removeClass("transition-out"),l.addClass("transition-in"),l.css("background-color","#"+currentTransitionColor),$(this.oldContainer).animate({opacity:0},800,function(){}).promise()},fadeIn:function(){var e=this,o=$(this.newContainer);$(this.oldContainer).hide(),$(window).scrollTop(0),i(),l.removeClass("transition-in"),l.addClass("transition-out"),o.css({visibility:"visible",opacity:0}),o.animate({opacity:1},800,function(){e.done(function(){})})},finish:function(){}});Barba.Pjax.getTransition=function(){return console.log("in transition"),e},Barba.Dispatcher.on("newPageReady",function(){t(),i(),s(this.namespace)});var s=function(e){$("body").removeClass(),$("body").addClass(e),console.log("body link updated to: ",e)},r=Barba.BaseView.extend({namespace:"home",onEnter:function(){console.log("alright, the homepage view is ready"),s(this.namespace)},onEnterCompleted:function(e){console.log("alright, the homepage view enter has completed. here is the namespace: ",this.namespace),o()},onLeave:function(){console.log("alright, we are leaving the homepage view")},onLeaveCompleted:function(){}}),c=Barba.BaseView.extend({namespace:"about",onEnter:function(){console.log("alright, the about view is ready"),s(this.namespace)},onEnterCompleted:function(){console.log("alright, the about view enter has completed"),o()},onLeave:function(){console.log("alright, we are leaving the about view")},onLeaveCompleted:function(){}}),d=Barba.BaseView.extend({namespace:"web",onEnter:function(){console.log("alright, the web view is ready"),s(this.namespace)},onEnterCompleted:function(){console.log("alright, the web view enter has completed"),o()},onLeave:function(){console.log("alright, we are leaving the web view")},onLeaveCompleted:function(){}}),g=Barba.BaseView.extend({namespace:"photo",onEnter:function(){console.log("alright, the photo view is ready"),s(this.namespace)},onEnterCompleted:function(){console.log("alright, the photo view enter has completed"),o()},onLeave:function(){console.log("alright, we are leaving the photo view")},onLeaveCompleted:function(){}}),h=Barba.BaseView.extend({namespace:"holga",onEnter:function(){console.log("alright, the holga view is ready"),s(this.namespace),$(".grid").css("background-color: black;")},onEnterCompleted:function(){console.log("alright, the photo view enter has completed"),o(),$(".grid").imagesLoaded().done(function(e){console.log("all images successfully loaded"),$(".grid").show()}).always(function(e){console.log("all images loaded"),a(".projects-container"),$(".grid").masonry({percentPosition:!0,gutter:30})}).fail(function(){console.log("all images loaded, at least one is broken")}).progress(function(e,o){var n=o.isLoaded?"loaded":"broken";console.log("image is "+n+" for "+o.img.src)})},onLeave:function(){console.log("alright, we are leaving the holga view")},onLeaveCompleted:function(){}}),u=Barba.BaseView.extend({namespace:"art",onEnter:function(){console.log("alright, the art view is ready"),s(this.namespace),console.log("here is what the body currently looks like: ",$("body"))},onEnterCompleted:function(){console.log("alright, the art view enter has completed"),console.log("here is the namespace",this.namespace),$(".grid").imagesLoaded().done(function(e){console.log("all images successfully loaded")}).always(function(e){console.log("all images loaded"),a(".projects-container"),$(".grid").masonry({percentPosition:!0,gutter:30})}).fail(function(){console.log("all images loaded, at least one is broken")}).progress(function(e,o){var n=o.isLoaded?"loaded":"broken";console.log("image is "+n+" for "+o.img.src)}),o()},onLeave:function(){console.log("alright, we are leaving the art view")},onLeaveCompleted:function(){}}),p=Barba.BaseView.extend({namespace:"illustration",onEnter:function(){console.log("alright, the illustration view is ready"),s(this.namespace),console.log("here is what the body currently looks like: ",$("body"))},onEnterCompleted:function(){console.log("alright, the illustration view enter has completed"),console.log("here is the namespace",this.namespace),$(".grid").imagesLoaded().done(function(e){console.log("all images successfully loaded")}).always(function(e){console.log("all images loaded"),a(".projects-container"),$(".grid").masonry({percentPosition:!0,gutter:30})}).fail(function(){console.log("all images loaded, at least one is broken")}).progress(function(e,o){var n=o.isLoaded?"loaded":"broken";console.log("image is "+n+" for "+o.img.src)}),o()},onLeave:function(){console.log("alright, we are leaving the illustration view")},onLeaveCompleted:function(){}}),m=Barba.BaseView.extend({namespace:"figure drawings",onEnter:function(){console.log("alright, the figureDrawings view is ready"),s(this.namespace),console.log("here is what the body currently looks like: ",$("body"))},onEnterCompleted:function(){console.log("alright, the figureDrawings view enter has completed"),console.log("here is the namespace",this.namespace),$(".grid").imagesLoaded().done(function(e){console.log("all images successfully loaded")}).always(function(e){console.log("all images loaded"),a(".projects-container"),$(".grid").masonry({percentPosition:!0,gutter:30})}).fail(function(){console.log("all images loaded, at least one is broken")}).progress(function(e,o){var n=o.isLoaded?"loaded":"broken";console.log("image is "+n+" for "+o.img.src)}),o()},onLeave:function(){console.log("alright, we are leaving the figureDrawings view")},onLeaveCompleted:function(){}});r.init(),u.init(),p.init(),m.init(),d.init(),g.init(),h.init(),c.init(),Barba.Pjax.start()});