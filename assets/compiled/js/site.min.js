...
var imageOptimizer=function(a,o){void 0!==typeof a&&null!==a||(a=".grid");var e=document.querySelector(a),r=[].slice.call(e.querySelectorAll("img.lazy"));if("IntersectionObserver"in window){config={rootMargin:"250px 0px"};var t=new IntersectionObserver(function(e,r){e.forEach(function(e){if(e.isIntersecting&&0<e.intersectionRatio){var r=e.target,n=new Image;n.onload=function(){r.src=this.src,$lazyImage=$(r),$lazyImage.removeClass("blur"),r.classList.add("unblur"),null!==o&&void 0!==typeof o&&$(a).masonry("layout")},n.src=r.dataset.src,t.unobserve(r)}})},config);r.forEach(function(e){t.observe(e)})}else r.forEach(function(e){e.src=e.dataset.src,$lazyImage.removeClass("blur"),e.classList.add("unblur")})};
