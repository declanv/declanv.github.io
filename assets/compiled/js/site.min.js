...
$(document).ready(function(){var n=window.requestAnimationFrame||function(e){window.setTimeout(e,1e3/60)},t=document.querySelectorAll(".show-on-scroll");!function e(){t.forEach(function(e){!function(e){"undefined"!=typeof jQuery&&e instanceof jQuery&&(e=e[0]);var n=e.getBoundingClientRect(),t=window.innerHeight||document.documentElement.clientHeight,i=window.innerWidth||document.documentElement.clientWidth;return 0<=n.left&&0<=n.top&&n.left+n.width/2<=i&&n.top+n.height/2<=t}(e)?(console.log("invisible"),e.classList.remove("play")):(console.log("visible"),e.classList.add("visible"),0==$(e).data("seen-yet")&&(console.log("hey, this thing hasn't been seen yet"),e.classList.add("play"),$(e).data("seen-yet",!0)))}),n(e)}()});
