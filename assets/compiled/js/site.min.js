...
$(document).ready(function(){var t=$(".subpages").prev(".page-link"),e=t.siblings(".subpages");console.log("here are the subpages: ",e);var a=function(){t.find(".page-link").removeClass("selected"),$(".trigger.box").removeClass("subnav-open"),e.addClass("closing-subnav"),e.removeClass("open")};mobileMenuOpen=!1;var o=function(){mobileMenuOpen=!1,$(".site-header").removeClass("open-mobile"),a()},i=function(){$("#menu").off("click"),$("#menu").on("click",function(){$(this).addClass("touched"),mobileMenuOpen?o():(mobileMenuOpen=!0,$(".site-header").addClass("open-mobile"))});var n=function(e){e.addClass("selected"),$(".trigger.box").addClass("subnav-open"),currentSubPageSet=e.siblings(".subpages"),$(".subpages").addClass("closing-subnav"),$(".subpages").not(currentSubPageSet).removeClass("open"),currentSubPageSet.addClass("open"),currentSubPageSet.removeClass("closing-subnav"),$(document).on("click.document",function(e){$(window).width()<=600&&mobileMenuOpen&&(t.is(e.target)||0!==t.has(e.target).length||$("#menu").is(e.target)||a())})};$(".page-link, .site-title").on("click",function(e){window.innerWidth<600&&0<$(this).siblings(".subpages").length?(e.preventDefault(),e.stopImmediatePropagation(),n($(this))):o()})};var n=!1;window.addEventListener("scroll",function(e){window.scrollY,n||(window.requestAnimationFrame(function(){document.querySelectorAll(".show-on-scroll").forEach(function(e){(function(e){"undefined"!=typeof jQuery&&e instanceof jQuery&&(e=e[0]);var n=e.getBoundingClientRect(),t=window.innerHeight||document.documentElement.clientHeight,a=window.innerWidth||document.documentElement.clientWidth;return 0<=n.left&&0<=n.top&&n.left+n.width/2.75<=a&&n.top+n.height/2.75<=t})(e)&&(e.classList.add("visible"),e.classList.add("play"))}),r(),n=!1}),n=!0)});window.requestAnimationFrame;function r(){$(window).scrollTop()>2*$(".site-header").outerHeight()?($("header").addClass("scroll-away"),$("header").removeClass("scroll-in"),$("header").removeClass("initial")):$(window).scrollTop()<=2*$(".site-header").outerHeight()&&!$(".siteheader").hasClass("initial")&&($("header").removeClass("scroll-away"),$("header").addClass("scroll-in")),$(".page-nav.next").length&&$(window).scrollTop()+$(window).height()>$(document).height()-300?$(".page-nav.next").addClass("open"):$(".page-nav.next").length&&$(window).scrollTop()+$(window).height()<$(document).height()-300&&$(".page-nav.next").removeClass("open")}var s=function(e){for(var n=function(e){(e=e||window.event).preventDefault?e.preventDefault():e.returnValue=!1;var n=e.target||e.srcElement,t=function e(n,t){return n&&(t(n)?n:e(n.parentNode,t))}(n,function(e){return e.tagName&&"FIGURE"===e.tagName.toUpperCase()&&"project-link-text"!==n.className});if(t){for(var a,o=t.parentNode,i=t.parentNode.childNodes,r=i.length,s=0,l=0;l<r;l++)if(1===i[l].nodeType){if(i[l]===t){a=s;break}s++}return 0<=a&&(console.log("open photoswipe bc valid index found"),d(a,o)),!1}},d=function(e,n,t,a){console.log("open photoswipe is actually happening");var o,i,r,s=document.querySelectorAll(".pswp")[0];if(r=function(e){for(var n,t,a,o,i=e.childNodes,r=i.length,s=[],l=0;l<r;l++)1===(n=i[l]).nodeType&&(a=(t=n.children[0]).getAttribute("data-size").split("x"),o={src:t.getAttribute("href"),w:parseInt(a[0],10),h:parseInt(a[1],10)},1<n.children.length&&(o.title=n.children[1].innerHTML),0<t.children.length&&(o.msrc=t.children[0].getAttribute("src")),o.el=n,s.push(o));return s}(n),i={galleryUID:n.getAttribute("data-pswp-uid"),getThumbBoundsFn:function(e){var n=r[e].el.getElementsByTagName("img")[0],t=window.pageYOffset||document.documentElement.scrollTop,a=n.getBoundingClientRect();return{x:a.left,y:a.top+t,w:a.width}}},a)if(i.galleryPIDs){for(var l=0;l<r.length;l++)if(r[l].pid==e){i.index=l;break}}else i.index=parseInt(e,10)-1;else i.index=parseInt(e,10);isNaN(i.index)||(t&&(i.showAnimationDuration=0),console.log("photoswipe, here is the element ",s,"here are the items: ",r,"here are the options: ",i),o=new PhotoSwipe(s,PhotoSwipeUI_Default,r,i),console.log("here is the gallery: ",o),o.init())},t=document.querySelectorAll(e),a=0,o=t.length;a<o;a++)t[a].setAttribute("data-pswp-uid",a+1),t[a].onclick=n;var i=function(){var e=window.location.hash.substring(1),n={};if(e.length<5)return n;for(var t=e.split("&"),a=0;a<t.length;a++)if(t[a]){var o=t[a].split("=");o.length<2||(n[o[0]]=o[1])}return n.gid&&(n.gid=parseInt(n.gid,10)),n}();i.pid&&i.gid&&d(i.pid,t[i.gid-1],!0,!0)},l=$("#transition-shape");defaultTransitionColor="#ffffff",currentTransitionColor=defaultTransitionColor,Barba.Dispatcher.on("linkClicked",function(e){currentTransitionColor=defaultTransitionColor,null!==e.dataset.hex&&void 0!==e.dataset.hex?currentTransitionColor=e.dataset.hex:currentTransitionColor=defaultTransitionColor});var d=Barba.BaseTransition.extend({start:function(){Promise.all([this.newContainerLoading,this.fadeOut()]).then(this.fadeIn.bind(this))},fadeOut:function(){return l.removeClass("transition-out"),l.addClass("transition-in"),l.css("background-color","#"+currentTransitionColor),$(this.oldContainer).animate({opacity:0},800,function(){}).promise().then(function(){c()})},fadeIn:function(){var e=this,n=$(this.newContainer);u(),$(this.oldContainer).hide(),$(window).scrollTop(0),r(),l.removeClass("transition-in"),l.addClass("transition-out"),n.css({visibility:"visible",opacity:0}),n.animate({opacity:1},800,function(){e.done(function(){})})},finish:function(){}});Barba.Pjax.getTransition=function(){return d};previousBodyClass="";var c=function(){$("body").removeClass(previousBodyClass)},u=function(){$("body").addClass(currentBodyClass)};$.each([{parent:"home",namespace:"home"},{parent:"web",namespace:"web"},{parent:"art",namespace:"art"},{parent:"art",namespace:"figure-drawings"},{parent:"art",namespace:"illustration"},{parent:"photo",namespace:"photo"},{parent:"photo",namespace:"holga"},{parent:"photo",namespace:"editorial"},{parent:"photo",namespace:"other"},{parent:"about",namespace:"about"}],function(e,n){!function(e,n){n.replace(/-([a-z])/g,function(e){return e[1].toUpperCase()});var t=n.replace(/-/g," ");(n=Barba.BaseView.extend({namespace:t,onEnter:function(){currentBodyClass=e,u()},onEnterCompleted:function(){i(),$(".grid").imagesLoaded().done(function(e){$(".grid").addClass("fade-in-grid")}).always(function(e){$(".grid").masonry({percentPosition:!0,gutter:30}),imageOptimizer(),s(".projects-container")}).fail(function(){}).progress(function(e,n){n.isLoaded})},onLeave:function(){previousBodyClass=e},onLeaveCompleted:function(){}})).init()}(n.parent,n.namespace)}),Barba.Pjax.start()});