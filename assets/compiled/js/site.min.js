...
$(document).ready(function(){var o=window.requestAnimationFrame||function(e){window.setTimeout(e,1e3/60)},n=document.querySelectorAll(".show-on-scroll");!function e(){n.forEach(function(e){!function(e){"undefined"!=typeof jQuery&&e instanceof jQuery&&(e=e[0]);var o=e.getBoundingClientRect(),n=window.innerHeight||document.documentElement.clientHeight,i=window.innerWidth||document.documentElement.clientWidth;return 0<=o.left&&0<=o.top&&o.left+o.width/2<=i&&o.top+o.height/2<=n}(e)?(console.log("invisible"),e.classList.remove("play")):(console.log("visible"),e.classList.add("visible"),e.classList.add("play"))}),o(e)}(),function e(){$(window).scrollTop()>=2*$(".site-header").outerHeight()?($("header").addClass("scroll-away"),$("header").removeClass("scroll-in"),$("header").removeClass("initial")):$(window).scrollTop()>=$(".site-header").outerHeight()&&($("header").removeClass("scroll-away"),$("header").addClass("scroll-in")),o(e)}()});
