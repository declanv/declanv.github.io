...
$(document).ready(function(){mobileMenuOpen=!1;var n=function(){console.log("mobile menu click triggered. Is the #menu around? ",$("#menu").length),$("#menu").on("click",function(){console.log("menu is clicked"),$(this).addClass("touched"),$(".site-header").toggleClass("open-mobile"),console.log("here is the mobileMenuOpen value: ",mobileMenuOpen),mobileMenuOpen?mobileMenuOpen=!1:mobileMenuOpen=!0}),$(".nav-w-children .page-link").on("click",function(e){var n,t;e.preventDefault(),$(this).addClass("selected"),$(".trigger.box").addClass("subnav-open"),$(this).siblings(".subpages").addClass("open"),$(this).siblings(".subpages").removeClass("closing-subnav"),n=$(".nav-w-children"),t=n.find(".subpages"),$(document).on("click.document",function(e){$(window).width()<650&&mobileMenuOpen&&(n.is(e.target)||0!==n.has(e.target).length||$("#menu").is(e.target)||(console.log("inside the clickOutsideClose and here is the element: ",e.target),n.find(".page-link").removeClass("selected"),$(".trigger.box").removeClass("subnav-open"),t.addClass("closing-subnav"),window.setTimeout(function(){t.removeClass("open")},100)))})})};var t=!1;window.addEventListener("scroll",function(e){window.scrollY,t||(window.requestAnimationFrame(function(){o(),i(),t=!1}),t=!0)});window.requestAnimationFrame;function o(){document.querySelectorAll(".show-on-scroll").forEach(function(e){(function(e){"undefined"!=typeof jQuery&&e instanceof jQuery&&(e=e[0]);var n=e.getBoundingClientRect(),t=window.innerHeight||document.documentElement.clientHeight,o=window.innerWidth||document.documentElement.clientWidth;return 0<=n.left&&0<=n.top&&n.left+n.width/2.75<=o&&n.top+n.height/2.75<=t})(e)&&(e.classList.add("visible"),e.classList.add("play"))})}function i(){$(window).scrollTop()>2*$(".site-header").outerHeight()?($("header").addClass("scroll-away"),$("header").removeClass("scroll-in"),$("header").removeClass("initial")):$(window).scrollTop()<=2*$(".site-header").outerHeight()&&!$(".siteheader").hasClass("initial")&&($("header").removeClass("scroll-away"),$("header").addClass("scroll-in")),$(".page-nav.next").length&&$(window).scrollTop()+$(window).height()>$(document).height()-300?(console.log("you're at the bottom of the page"),$(".page-nav.next").addClass("open")):$(".page-nav.next").length&&$(window).scrollTop()+$(window).height()<$(document).height()-300&&$(".page-nav.next").removeClass("open")}var e=function(e){console.log("init photo swipe is actually happening");var n=function(e){console.log("in onthumbnails click"),(e=e||window.event).preventDefault?e.preventDefault():e.returnValue=!1;var n=function e(n,t){return n&&(t(n)?n:e(n.parentNode,t))}(e.target||e.srcElement,function(e){return e.tagName&&"FIGURE"===e.tagName.toUpperCase()});if(n){for(var t,o=n.parentNode,i=n.parentNode.childNodes,a=i.length,l=0,r=0;r<a;r++)if(1===i[r].nodeType){if(i[r]===n){t=l;break}l++}return 0<=t&&(console.log("open photoswipe bc valid index found"),s(t,o)),!1}},s=function(e,n,t,o){console.log("open photoswipe is actually happening");var i,a,l,r=document.querySelectorAll(".pswp")[0];if(l=function(e){for(var n,t,o,i,a=e.childNodes,l=a.length,r=[],s=0;s<l;s++)1===(n=a[s]).nodeType&&(o=(t=n.children[0]).getAttribute("data-size").split("x"),i={src:t.getAttribute("href"),w:parseInt(o[0],10),h:parseInt(o[1],10)},1<n.children.length&&(i.title=n.children[1].innerHTML),0<t.children.length&&(i.msrc=t.children[0].getAttribute("src")),i.el=n,r.push(i));return r}(n),a={galleryUID:n.getAttribute("data-pswp-uid"),getThumbBoundsFn:function(e){var n=l[e].el.getElementsByTagName("img")[0],t=window.pageYOffset||document.documentElement.scrollTop,o=n.getBoundingClientRect();return{x:o.left,y:o.top+t,w:o.width}}},o)if(a.galleryPIDs){for(var s=0;s<l.length;s++)if(l[s].pid==e){a.index=s;break}}else a.index=parseInt(e,10)-1;else a.index=parseInt(e,10);isNaN(a.index)||(t&&(a.showAnimationDuration=0),console.log("photoswipe, here is the element ",r,"here are the items: ",l,"here are the options: ",a),i=new PhotoSwipe(r,PhotoSwipeUI_Default,l,a),console.log("here is the gallery: ",i),i.init())},t=document.querySelectorAll(e);console.log("here are the galleryElements",t);for(var o=0,i=t.length;o<i;o++)t[o].setAttribute("data-pswp-uid",o+1),t[o].onclick=n;var a=function(){var e=window.location.hash.substring(1),n={};if(e.length<5)return n;for(var t=e.split("&"),o=0;o<t.length;o++)if(t[o]){var i=t[o].split("=");i.length<2||(n[i[0]]=i[1])}return n.gid&&(n.gid=parseInt(n.gid,10)),n}();a.pid&&a.gid&&s(a.pid,t[a.gid-1],!0,!0)},a=$("#transition-shape");defaultTransitionColor="#ffffff",currentTransitionColor=defaultTransitionColor,Barba.Dispatcher.on("linkClicked",function(e){currentTransitionColor=defaultTransitionColor,console.log("here is the el being clicked: ",e),null!==e.dataset.hex&&void 0!==e.dataset.hex?currentTransitionColor=e.dataset.hex:currentTransitionColor=defaultTransitionColor});var l=Barba.BaseTransition.extend({start:function(){Promise.all([this.newContainerLoading,this.fadeOut()]).then(this.fadeIn.bind(this))},fadeOut:function(){return console.log("here is what the background color will look like: ","#"+currentTransitionColor),a.removeClass("transition-out"),a.addClass("transition-in"),a.css("background-color","#"+currentTransitionColor),$(this.oldContainer).animate({opacity:0},800,function(){}).promise()},fadeIn:function(){var e=this,n=$(this.newContainer);$(this.oldContainer).hide(),$(window).scrollTop(0),i(),a.removeClass("transition-in"),a.addClass("transition-out"),n.css({visibility:"visible",opacity:0}),n.animate({opacity:1},800,function(){e.done(function(){})})},finish:function(){}});Barba.Pjax.getTransition=function(){return console.log("in transition"),l},Barba.Dispatcher.on("newPageReady",function(){o(),i(),r(this.namespace)});var r=function(e){$("body").removeClass(),$("body").addClass(e),console.log("body link updated to: ",e)},s=Barba.BaseView.extend({namespace:"home",onEnter:function(){console.log("alright, the homepage view is ready"),r(this.namespace)},onEnterCompleted:function(e){console.log("alright, the homepage view enter has completed. here is the namespace: ",this.namespace),n()},onLeave:function(){console.log("alright, we are leaving the homepage view")},onLeaveCompleted:function(){}}),c=Barba.BaseView.extend({namespace:"about",onEnter:function(){console.log("alright, the about view is ready"),r(this.namespace)},onEnterCompleted:function(){console.log("alright, the about view enter has completed"),n()},onLeave:function(){console.log("alright, we are leaving the about view")},onLeaveCompleted:function(){}}),d=Barba.BaseView.extend({namespace:"web",onEnter:function(){console.log("alright, the web view is ready"),r(this.namespace)},onEnterCompleted:function(){console.log("alright, the web view enter has completed"),n()},onLeave:function(){console.log("alright, we are leaving the web view")},onLeaveCompleted:function(){}}),h=Barba.BaseView.extend({namespace:"photo",onEnter:function(){console.log("alright, the photo view is ready"),r(this.namespace)},onEnterCompleted:function(){console.log("alright, the photo view enter has completed"),n()},onLeave:function(){console.log("alright, we are leaving the photo view")},onLeaveCompleted:function(){}}),u=Barba.BaseView.extend({namespace:"art",onEnter:function(){console.log("alright, the art view is ready"),r(this.namespace),console.log("here is what the body currently looks like: ",$("body"))},onEnterCompleted:function(){console.log("alright, the art view enter has completed"),console.log("here is the namespace",this.namespace),e(".projects-container"),$(".grid").masonry({percentPosition:!0,gutter:30}),n()},onLeave:function(){console.log("alright, we are leaving the art view")},onLeaveCompleted:function(){}});s.init(),u.init(),d.init(),h.init(),c.init(),Barba.Pjax.start()});