...
var imageOptimizer=function(o,t){void 0!==typeof o&&null!==o||(o=".grid");var e=document.querySelector(o),r=[].slice.call(e.querySelectorAll("img.lazy"));if("IntersectionObserver"in window){config={rootMargin:"250px 0px"};var i=new IntersectionObserver(function(e,r){e.forEach(function(e){if(e.isIntersecting&&0<e.intersectionRatio){var r=e.target,n=new Image;n.onload=function(){r.src=this.src,$lazyImage=$(r),$lazyImage.removeClass("blur"),r.classList.add("unblur"),null!==t&&void 0!==typeof t&&$(o).masonry("layout")},n.src=r.dataset.src,i.unobserve(r)}})},config);r.forEach(function(e){i.observe(e)})}else r.forEach(function(e){e.src=e.dataset.src,e.classList.remove("blur"),e.classList.add("unblur")})};
