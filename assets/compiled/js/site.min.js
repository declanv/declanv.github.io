...
$(document).ready(function(){mobileMenuOpen=!1;var o=function(){console.log("mobile menu click triggered. Is the #menu around? ",$("#menu").length),$("#menu").on("click",function(){console.log("menu is clicked"),$(this).addClass("touched"),$(".site-header").toggleClass("open-mobile"),console.log("here is the mobileMenuOpen value: ",mobileMenuOpen),mobileMenuOpen?mobileMenuOpen=!1:mobileMenuOpen=!0}),$(".subpages").siblings(".page-link").on("click",function(e){e.preventDefault(),$(this).addClass("selected"),$(".trigger.box").addClass("subnav-open"),$(this).siblings(".subpages").addClass("open"),$(this).siblings(".subpages").removeClass("closing-subnav")})};var n=!1;window.addEventListener("scroll",function(e){window.scrollY,n||(window.requestAnimationFrame(function(){i(),t(),n=!1}),n=!0)});window.requestAnimationFrame;function i(){document.querySelectorAll(".show-on-scroll").forEach(function(e){(function(e){"undefined"!=typeof jQuery&&e instanceof jQuery&&(e=e[0]);var o=e.getBoundingClientRect(),n=window.innerHeight||document.documentElement.clientHeight,i=window.innerWidth||document.documentElement.clientWidth;return 0<=o.left&&0<=o.top&&o.left+o.width/2.75<=i&&o.top+o.height/2.75<=n})(e)&&(e.classList.add("visible"),e.classList.add("play"))})}function t(){$(window).scrollTop()>2*$(".site-header").outerHeight()?($("header").addClass("scroll-away"),$("header").removeClass("scroll-in"),$("header").removeClass("initial")):$(window).scrollTop()<=2*$(".site-header").outerHeight()&&!$(".siteheader").hasClass("initial")&&($("header").removeClass("scroll-away"),$("header").addClass("scroll-in")),$(".page-nav.next").length&&$(window).scrollTop()+$(window).height()>$(document).height()-300?(console.log("you're at the bottom of the page"),$(".page-nav.next").addClass("open")):$(".page-nav.next").length&&$(window).scrollTop()+$(window).height()<$(document).height()-300&&$(".page-nav.next").removeClass("open")}var a=$("#transition-shape");defaultTransitionColor="#ffffff",currentTransitionColor=defaultTransitionColor,Barba.Dispatcher.on("linkClicked",function(e){currentTransitionColor=defaultTransitionColor,console.log("here is the el being clicked: ",e),null!==e.dataset.hex&&void 0!==e.dataset.hex?currentTransitionColor=e.dataset.hex:currentTransitionColor=defaultTransitionColor});var e=Barba.BaseTransition.extend({start:function(){Promise.all([this.newContainerLoading,this.fadeOut()]).then(this.fadeIn.bind(this))},fadeOut:function(){return console.log("here is what the background color will look like: ","#"+currentTransitionColor),a.removeClass("transition-out"),a.addClass("transition-in"),a.css("background-color","#"+currentTransitionColor),$(this.oldContainer).animate({opacity:0},800,function(){}).promise()},fadeIn:function(){var e=this,o=$(this.newContainer);$(this.oldContainer).hide(),$(window).scrollTop(0),t(),a.removeClass("transition-in"),a.addClass("transition-out"),o.css({visibility:"visible",opacity:0}),o.animate({opacity:1},800,function(){e.done(function(){})})},finish:function(){}});Barba.Pjax.getTransition=function(){return console.log("in transition"),e},Barba.Dispatcher.on("newPageReady",function(){i(),t(),l(this.namespace)});var l=function(e){$("body").removeClass(),$("body").addClass(e),console.log("body link updated to: ",e)},s=Barba.BaseView.extend({namespace:"home",onEnter:function(){console.log("alright, the homepage view is ready"),l(this.namespace)},onEnterCompleted:function(e){console.log("alright, the homepage view enter has completed. here is the namespace: ",this.namespace),o()},onLeave:function(){console.log("alright, we are leaving the homepage view")},onLeaveCompleted:function(){}}),r=Barba.BaseView.extend({namespace:"about",onEnter:function(){console.log("alright, the about view is ready"),l(this.namespace)},onEnterCompleted:function(){console.log("alright, the about view enter has completed"),o()},onLeave:function(){console.log("alright, we are leaving the about view")},onLeaveCompleted:function(){}}),c=Barba.BaseView.extend({namespace:"web",onEnter:function(){console.log("alright, the web view is ready"),l(this.namespace)},onEnterCompleted:function(){console.log("alright, the web view enter has completed"),o()},onLeave:function(){console.log("alright, we are leaving the web view")},onLeaveCompleted:function(){}}),d=Barba.BaseView.extend({namespace:"photo",onEnter:function(){console.log("alright, the photo view is ready"),l(this.namespace)},onEnterCompleted:function(){console.log("alright, the photo view enter has completed"),o()},onLeave:function(){console.log("alright, we are leaving the photo view")},onLeaveCompleted:function(){}}),g=Barba.BaseView.extend({namespace:"holga",onEnter:function(){console.log("alright, the holga view is ready"),l(this.namespace),$(".grid").css("background-color: black;")},onEnterCompleted:function(){console.log("alright, the photo view enter has completed"),o(),$(".grid").imagesLoaded().done(function(e){console.log("all images successfully loaded"),$(".grid").addClass("fade-in-grid")}).always(function(e){console.log("all images loaded"),$(".grid").masonry({percentPosition:!0,gutter:30}),imageOptimizer(),initPhotoSwipeFromDOM(".projects-container")}).fail(function(){console.log("all images loaded, at least one is broken")}).progress(function(e,o){var n=o.isLoaded?"loaded":"broken";console.log("image is "+n+" for "+o.img.src)})},onLeave:function(){console.log("alright, we are leaving the holga view")},onLeaveCompleted:function(){}}),h=Barba.BaseView.extend({namespace:"art",onEnter:function(){console.log("alright, the art view is ready"),l(this.namespace),console.log("here is what the body currently looks like: ",$("body"))},onEnterCompleted:function(){console.log("alright, the art view enter has completed"),console.log("here is the namespace",this.namespace),$(".grid").imagesLoaded().done(function(e){console.log("all images successfully loaded")}).always(function(e){console.log("all images loaded"),initPhotoSwipeFromDOM(".projects-container"),$(".grid").masonry({percentPosition:!0,gutter:30})}).fail(function(){console.log("all images loaded, at least one is broken")}).progress(function(e,o){var n=o.isLoaded?"loaded":"broken";console.log("image is "+n+" for "+o.img.src)}),o()},onLeave:function(){console.log("alright, we are leaving the art view")},onLeaveCompleted:function(){}}),u=Barba.BaseView.extend({namespace:"illustration",onEnter:function(){console.log("alright, the illustration view is ready"),l(this.namespace),console.log("here is what the body currently looks like: ",$("body"))},onEnterCompleted:function(){console.log("alright, the illustration view enter has completed"),console.log("here is the namespace",this.namespace),$(".grid").imagesLoaded().done(function(e){console.log("all images successfully loaded")}).always(function(e){console.log("all images loaded"),initPhotoSwipeFromDOM(".projects-container"),$(".grid").masonry({percentPosition:!0,gutter:30})}).fail(function(){console.log("all images loaded, at least one is broken")}).progress(function(e,o){var n=o.isLoaded?"loaded":"broken";console.log("image is "+n+" for "+o.img.src)}),o()},onLeave:function(){console.log("alright, we are leaving the illustration view")},onLeaveCompleted:function(){}}),m=Barba.BaseView.extend({namespace:"figure drawings",onEnter:function(){console.log("alright, the figureDrawings view is ready"),l(this.namespace),console.log("here is what the body currently looks like: ",$("body"))},onEnterCompleted:function(){console.log("alright, the figureDrawings view enter has completed"),console.log("here is the namespace",this.namespace),$(".grid").imagesLoaded().done(function(e){console.log("all images successfully loaded")}).always(function(e){console.log("all images loaded"),initPhotoSwipeFromDOM(".projects-container"),$(".grid").masonry({percentPosition:!0,gutter:30})}).fail(function(){console.log("all images loaded, at least one is broken")}).progress(function(e,o){var n=o.isLoaded?"loaded":"broken";console.log("image is "+n+" for "+o.img.src)}),o()},onLeave:function(){console.log("alright, we are leaving the figureDrawings view")},onLeaveCompleted:function(){}});s.init(),h.init(),u.init(),m.init(),c.init(),d.init(),g.init(),r.init(),Barba.Pjax.start()});