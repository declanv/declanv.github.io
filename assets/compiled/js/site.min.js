...
var imageOptimizer=function(){var e=[].slice.call(document.querySelectorAll("img.lazy"));if("IntersectionObserver"in window){config={rootMargin:"250px 0px"};var n=new IntersectionObserver(function(e,r){e.forEach(function(e){if(e.isIntersecting){var r=e.target;r.src=r.dataset.src,$lazyImage=$(r),$lazyImage.parent().addClass("unblur"),n.unobserve(r)}})},config);e.forEach(function(e){n.observe(e)})}else e.forEach(function(e){e.src=e.dataset.src})};imageOptimizer();
$(document).ready(function(){mobileMenuOpen=!1;var t=function(){mobileMenuOpen=!1,$(".site-header").removeClass("open-mobile"),console.log("closing mobile menu.")},o=function(){console.log("mobile menu click triggered. Is the #menu around? ",$("#menu").length),$("#menu").off("click"),$("#menu").on("click",function(){$(this).addClass("touched"),mobileMenuOpen?t():(mobileMenuOpen=!0,$(".site-header").addClass("open-mobile"))});var n=function(e){var n,t;e.addClass("selected"),$(".trigger.box").addClass("subnav-open"),currentSubPageSet=e.siblings(".subpages"),$(".subpages").addClass("closing-subnav"),$(".subpages").not(currentSubPageSet).removeClass("open"),currentSubPageSet.addClass("open"),currentSubPageSet.removeClass("closing-subnav"),n=$(".subpages").prev(".page-link"),t=n.find(".subpages"),$(document).on("click.document",function(e){$(window).width()<650&&mobileMenuOpen&&(n.is(e.target)||0!==n.has(e.target).length||$("#menu").is(e.target)||(console.log("inside the clickOutsideClose and here is the element: ",e.target),n.find(".page-link").removeClass("selected"),$(".trigger.box").removeClass("subnav-open"),t.addClass("closing-subnav"),t.removeClass("open")))})};$(".page-link, .site-title").on("click",function(e){window.innerWidth<600&&0<$(this).siblings(".subpages").length?(e.preventDefault(),e.stopImmediatePropagation(),n($(this))):t()})};var n=!1;window.addEventListener("scroll",function(e){window.scrollY,n||(window.requestAnimationFrame(function(){document.querySelectorAll(".show-on-scroll").forEach(function(e){(function(e){"undefined"!=typeof jQuery&&e instanceof jQuery&&(e=e[0]);var n=e.getBoundingClientRect(),t=window.innerHeight||document.documentElement.clientHeight,o=window.innerWidth||document.documentElement.clientWidth;return 0<=n.left&&0<=n.top&&n.left+n.width/2.75<=o&&n.top+n.height/2.75<=t})(e)&&(e.classList.add("visible"),e.classList.add("play"))}),i(),n=!1}),n=!0)});window.requestAnimationFrame;function i(){$(window).scrollTop()>2*$(".site-header").outerHeight()?($("header").addClass("scroll-away"),$("header").removeClass("scroll-in"),$("header").removeClass("initial")):$(window).scrollTop()<=2*$(".site-header").outerHeight()&&!$(".siteheader").hasClass("initial")&&($("header").removeClass("scroll-away"),$("header").addClass("scroll-in")),$(".page-nav.next").length&&$(window).scrollTop()+$(window).height()>$(document).height()-300?(console.log("you're at the bottom of the page"),$(".page-nav.next").addClass("open")):$(".page-nav.next").length&&$(window).scrollTop()+$(window).height()<$(document).height()-300&&$(".page-nav.next").removeClass("open")}var a=function(e){for(var n=function(e){console.log("in onthumbnails click"),(e=e||window.event).preventDefault?e.preventDefault():e.returnValue=!1;var n=e.target||e.srcElement,t=function e(n,t){return n&&(t(n)?n:e(n.parentNode,t))}(n,function(e){return console.log("here is the element in clickedListItem function: ",e,"and here is the eTarget: ",n),e.tagName&&"FIGURE"===e.tagName.toUpperCase()&&"project-link-text"!==n.className});if(console.log("here is the clickedListItem: ",t),t){for(var o,i=t.parentNode,a=t.parentNode.childNodes,r=a.length,s=0,l=0;l<r;l++)if(1===a[l].nodeType){if(a[l]===t){o=s;break}s++}return 0<=o&&(console.log("open photoswipe bc valid index found"),d(o,i)),!1}},d=function(e,n,t,o){console.log("open photoswipe is actually happening");var i,a,r,s=document.querySelectorAll(".pswp")[0];if(r=function(e){for(var n,t,o,i,a=e.childNodes,r=a.length,s=[],l=0;l<r;l++)1===(n=a[l]).nodeType&&(o=(t=n.children[0]).getAttribute("data-size").split("x"),i={src:t.getAttribute("href"),w:parseInt(o[0],10),h:parseInt(o[1],10)},1<n.children.length&&(i.title=n.children[1].innerHTML),0<t.children.length&&(i.msrc=t.children[0].getAttribute("src")),i.el=n,s.push(i));return s}(n),a={galleryUID:n.getAttribute("data-pswp-uid"),getThumbBoundsFn:function(e){var n=r[e].el.getElementsByTagName("img")[0],t=window.pageYOffset||document.documentElement.scrollTop,o=n.getBoundingClientRect();return{x:o.left,y:o.top+t,w:o.width}}},o)if(a.galleryPIDs){for(var l=0;l<r.length;l++)if(r[l].pid==e){a.index=l;break}}else a.index=parseInt(e,10)-1;else a.index=parseInt(e,10);isNaN(a.index)||(t&&(a.showAnimationDuration=0),console.log("photoswipe, here is the element ",s,"here are the items: ",r,"here are the options: ",a),i=new PhotoSwipe(s,PhotoSwipeUI_Default,r,a),console.log("here is the gallery: ",i),i.init())},t=document.querySelectorAll(e),o=0,i=t.length;o<i;o++)t[o].setAttribute("data-pswp-uid",o+1),t[o].onclick=n;var a=function(){var e=window.location.hash.substring(1),n={};if(e.length<5)return n;for(var t=e.split("&"),o=0;o<t.length;o++)if(t[o]){var i=t[o].split("=");i.length<2||(n[i[0]]=i[1])}return n.gid&&(n.gid=parseInt(n.gid,10)),n}();a.pid&&a.gid&&d(a.pid,t[a.gid-1],!0,!0)},r=$("#transition-shape");defaultTransitionColor="#ffffff",currentTransitionColor=defaultTransitionColor,Barba.Dispatcher.on("linkClicked",function(e){currentTransitionColor=defaultTransitionColor,null!==e.dataset.hex&&void 0!==e.dataset.hex?currentTransitionColor=e.dataset.hex:currentTransitionColor=defaultTransitionColor});var e=Barba.BaseTransition.extend({start:function(){Promise.all([this.newContainerLoading,this.fadeOut()]).then(this.fadeIn.bind(this))},fadeOut:function(){return console.log("here is what the background color will look like: ","#"+currentTransitionColor),r.removeClass("transition-out"),r.addClass("transition-in"),r.css("background-color","#"+currentTransitionColor),$(this.oldContainer).animate({opacity:0},800,function(){}).promise().then(function(){s()})},fadeIn:function(){var e=this,n=$(this.newContainer);l(),$(this.oldContainer).hide(),$(window).scrollTop(0),i(),r.removeClass("transition-in"),r.addClass("transition-out"),n.css({visibility:"visible",opacity:0}),n.animate({opacity:1},800,function(){e.done(function(){})})},finish:function(){}});Barba.Pjax.getTransition=function(){return e};previousBodyClass="";var s=function(){console.log("here is the previous body class: ",previousBodyClass),$("body").removeClass(previousBodyClass)},l=function(){$("body").addClass(currentBodyClass)};$.each([{parent:"home",namespace:"home"},{parent:"web",namespace:"web"},{parent:"art",namespace:"art"},{parent:"art",namespace:"figure-drawings"},{parent:"art",namespace:"illustration"},{parent:"photo",namespace:"photo"},{parent:"photo",namespace:"holga"},{parent:"photo",namespace:"editorial"},{parent:"photo",namespace:"other"},{parent:"about",namespace:"about"}],function(e,n){!function(e,n){n.replace(/-([a-z])/g,function(e){return e[1].toUpperCase()});var t=n.replace(/-/g," ");(n=Barba.BaseView.extend({namespace:t,onEnter:function(){currentBodyClass=e,l()},onEnterCompleted:function(){o(),$(".grid").imagesLoaded().done(function(e){$(".grid").addClass("fade-in-grid")}).always(function(e){$(".grid").masonry({percentPosition:!0,gutter:30}),imageOptimizer(),a(".projects-container")}).fail(function(){}).progress(function(e,n){n.isLoaded})},onLeave:function(){previousBodyClass=e},onLeaveCompleted:function(){}})).init()}(n.parent,n.namespace)}),Barba.Pjax.start()});