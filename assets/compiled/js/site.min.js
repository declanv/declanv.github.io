...
$(document).ready(function(){mobileMenuOpen=!1;var e=function(){mobileMenuOpen=!1,$(".site-header").removeClass("open-mobile"),console.log("closing mobile menu.")},i=function(){console.log("mobile menu click triggered. Is the #menu around? ",$("#menu").length),$("#menu").off("click"),$("#menu").on("click",function(){console.log("menu is clicked"),$(this).addClass("touched"),mobileMenuOpen?e():(mobileMenuOpen=!0,$(".site-header").addClass("open-mobile"),console.log("opening mobile menu."))}),$(".page-link, .site-title").on("click",function(){e()}),$(".subpages").siblings(".page-link").on("click",function(e){e.preventDefault(),$(this).addClass("selected"),$(".trigger.box").addClass("subnav-open"),$(this).siblings(".subpages").addClass("open"),$(this).siblings(".subpages").removeClass("closing-subnav")})};var n=!1;window.addEventListener("scroll",function(e){window.scrollY,n||(window.requestAnimationFrame(function(){document.querySelectorAll(".show-on-scroll").forEach(function(e){(function(e){"undefined"!=typeof jQuery&&e instanceof jQuery&&(e=e[0]);var n=e.getBoundingClientRect(),o=window.innerHeight||document.documentElement.clientHeight,t=window.innerWidth||document.documentElement.clientWidth;return 0<=n.left&&0<=n.top&&n.left+n.width/2.75<=t&&n.top+n.height/2.75<=o})(e)&&(e.classList.add("visible"),e.classList.add("play"))}),o(),n=!1}),n=!0)});window.requestAnimationFrame;function o(){$(window).scrollTop()>2*$(".site-header").outerHeight()?($("header").addClass("scroll-away"),$("header").removeClass("scroll-in"),$("header").removeClass("initial")):$(window).scrollTop()<=2*$(".site-header").outerHeight()&&!$(".siteheader").hasClass("initial")&&($("header").removeClass("scroll-away"),$("header").addClass("scroll-in")),$(".page-nav.next").length&&$(window).scrollTop()+$(window).height()>$(document).height()-300?(console.log("you're at the bottom of the page"),$(".page-nav.next").addClass("open")):$(".page-nav.next").length&&$(window).scrollTop()+$(window).height()<$(document).height()-300&&$(".page-nav.next").removeClass("open")}var a=function(e){console.log("init photo swipe is actually happening");var n=function(e){console.log("in onthumbnails click"),(e=e||window.event).preventDefault?e.preventDefault():e.returnValue=!1;var n=e.target||e.srcElement,o=function e(n,o){return n&&(o(n)?n:e(n.parentNode,o))}(n,function(e){return console.log("here is the element in clickedListItem function: ",e,"and here is the eTarget: ",n),e.tagName&&"FIGURE"===e.tagName.toUpperCase()&&"project-link-text"!==n.className});if(console.log("here is the clickedListItem: ",o),o){for(var t,i=o.parentNode,a=o.parentNode.childNodes,s=a.length,r=0,l=0;l<s;l++)if(1===a[l].nodeType){if(a[l]===o){t=r;break}r++}return 0<=t&&(console.log("open photoswipe bc valid index found"),c(t,i)),!1}},c=function(e,n,o,t){console.log("open photoswipe is actually happening");var i,a,s,r=document.querySelectorAll(".pswp")[0];if(s=function(e){for(var n,o,t,i,a=e.childNodes,s=a.length,r=[],l=0;l<s;l++)1===(n=a[l]).nodeType&&(t=(o=n.children[0]).getAttribute("data-size").split("x"),i={src:o.getAttribute("href"),w:parseInt(t[0],10),h:parseInt(t[1],10)},1<n.children.length&&(i.title=n.children[1].innerHTML),0<o.children.length&&(i.msrc=o.children[0].getAttribute("src")),i.el=n,r.push(i));return r}(n),a={galleryUID:n.getAttribute("data-pswp-uid"),getThumbBoundsFn:function(e){var n=s[e].el.getElementsByTagName("img")[0],o=window.pageYOffset||document.documentElement.scrollTop,t=n.getBoundingClientRect();return{x:t.left,y:t.top+o,w:t.width}}},t)if(a.galleryPIDs){for(var l=0;l<s.length;l++)if(s[l].pid==e){a.index=l;break}}else a.index=parseInt(e,10)-1;else a.index=parseInt(e,10);isNaN(a.index)||(o&&(a.showAnimationDuration=0),console.log("photoswipe, here is the element ",r,"here are the items: ",s,"here are the options: ",a),i=new PhotoSwipe(r,PhotoSwipeUI_Default,s,a),console.log("here is the gallery: ",i),i.init())},o=document.querySelectorAll(e);console.log("here are the galleryElements",o);for(var t=0,i=o.length;t<i;t++)o[t].setAttribute("data-pswp-uid",t+1),o[t].onclick=n;var a=function(){var e=window.location.hash.substring(1),n={};if(e.length<5)return n;for(var o=e.split("&"),t=0;t<o.length;t++)if(o[t]){var i=o[t].split("=");i.length<2||(n[i[0]]=i[1])}return n.gid&&(n.gid=parseInt(n.gid,10)),n}();a.pid&&a.gid&&c(a.pid,o[a.gid-1],!0,!0)},t=$("#transition-shape");defaultTransitionColor="#ffffff",currentTransitionColor=defaultTransitionColor,Barba.Dispatcher.on("linkClicked",function(e){currentTransitionColor=defaultTransitionColor,console.log("here is the el being clicked: ",e),null!==e.dataset.hex&&void 0!==e.dataset.hex?currentTransitionColor=e.dataset.hex:currentTransitionColor=defaultTransitionColor});var s=Barba.BaseTransition.extend({start:function(){Promise.all([this.newContainerLoading,this.fadeOut()]).then(this.fadeIn.bind(this))},fadeOut:function(){return console.log("here is what the background color will look like: ","#"+currentTransitionColor),t.removeClass("transition-out"),t.addClass("transition-in"),t.css("background-color","#"+currentTransitionColor),$(this.oldContainer).animate({opacity:0},800,function(){}).promise().then(function(){r()})},fadeIn:function(){var e=this,n=$(this.newContainer);l(),$(this.oldContainer).hide(),$(window).scrollTop(0),o(),t.removeClass("transition-in"),t.addClass("transition-out"),n.css({visibility:"visible",opacity:0}),n.animate({opacity:1},800,function(){e.done(function(){})})},finish:function(){}});Barba.Pjax.getTransition=function(){return console.log("in transition"),s};previousBodyClass="";var r=function(){console.log("removing the previousBodyLink: ",previousBodyClass),$("body").removeClass(previousBodyClass)},l=function(){console.log("adding the currentBodyClass: ",currentBodyClass),$("body").addClass(currentBodyClass)};$.each([{parent:"home",namespace:"home"},{parent:"web",namespace:"web"},{parent:"art",namespace:"art"},{parent:"art",namespace:"figureDrawings"},{parent:"art",namespace:"illustration"},{parent:"photo",namespace:"photo"},{parent:"photo",namespace:"holga"},{parent:"photo",namespace:"other"}],function(e,n){var o,t;o=n.parent,t=n.namespace,(t=Barba.BaseView.extend({namespace:t,onEnter:function(){currentBodyClass=o},onEnterCompleted:function(){i(),$(".grid").imagesLoaded().done(function(e){console.log("all images successfully loaded"),$(".grid").addClass("fade-in-grid")}).always(function(e){$(".grid").masonry({percentPosition:!0,gutter:30}),imageOptimizer(),a(".projects-container")}).fail(function(){console.log("all images loaded, at least one is broken")}).progress(function(e,n){var o=n.isLoaded?"loaded":"broken";console.log("image is "+o+" for "+n.img.src)})},onLeave:function(){previousBodyClass=o,console.log("alright, we are leaving the "+this.namespace+" view")},onLeaveCompleted:function(){}})).init()}),Barba.Pjax.start()});