...
$(document).ready(function(){var o=window.requestAnimationFrame||function(e){window.setTimeout(e,1e3/60)},n=document.querySelectorAll(".show-on-scroll");!function e(){n.forEach(function(e){!function(e){"undefined"!=typeof jQuery&&e instanceof jQuery&&(e=e[0]);var o=e.getBoundingClientRect(),n=window.innerHeight||document.documentElement.clientHeight,i=window.innerWidth||document.documentElement.clientWidth;return 0<=o.left&&0<=o.top&&o.left+o.width/2<=i&&o.top+o.height/2<=n}(e)?console.log("invisible"):(console.log("visible"),e.classList.add("visible"),e.classList.add("play"))}),o(e)}(),function e(){$(window).scrollTop()>=2*$(".site-header").outerHeight()?($("header").addClass("scroll-away"),$("header").removeClass("scroll-in"),$("header").removeClass("initial"),console.log("we are scrolling out")):$(window).scrollTop()<=2*$(".site-header").outerHeight()&&!$(".siteheader").hasClass("initial")&&(console.log("we are scrolling in"),$("header").removeClass("scroll-away"),$("header").addClass("scroll-in")),o(e)}()});
$(document).ready(function(){console.log("something!");var e=Barba.BaseTransition.extend({start:function(){Promise.all([this.newContainerLoading,this.fadeOut()]).then(this.fadeIn.bind(this))},fadeOut:function(){return $(this.oldContainer).animate({opacity:0}).promise()},fadeIn:function(){var e=this,n=$(this.newContainer);$(this.oldContainer).hide(),n.css({visibility:"visible",opacity:0}),n.animate({opacity:1},400,function(){e.done()})}});Barba.Pjax.getTransition=function(){return console.log("in transition"),e},Barba.Dispatcher.on("linkClicked",function(){console.log("link clicked: ",this)});var n=function(e){$("body").removeClass(),$("body").addClass(e)},o=Barba.BaseView.extend({namespace:"home",onEnter:function(){console.log("alright, the homepage view is ready"),n(this.namespace)},onEnterCompleted:function(e){console.log("alright, the homepage view enter has completed. here is the namespace: ",this.namespace)},onLeave:function(){console.log("alright, we are leaving the homepage view")},onLeaveCompleted:function(){}}),t=Barba.BaseView.extend({namespace:"about",onEnter:function(){console.log("alright, the about view is ready"),n(this.namespace)},onEnterCompleted:function(){console.log("alright, the about view enter has completed")},onLeave:function(){console.log("alright, we are leaving the about view")},onLeaveCompleted:function(){}}),a=Barba.BaseView.extend({namespace:"web",onEnter:function(){console.log("alright, the web view is ready"),n(this.namespace)},onEnterCompleted:function(){console.log("alright, the web view enter has completed")},onLeave:function(){console.log("alright, we are leaving the web view")},onLeaveCompleted:function(){}}),i=Barba.BaseView.extend({namespace:"photo",onEnter:function(){console.log("alright, the photo view is ready"),n(this.namespace)},onEnterCompleted:function(){console.log("alright, the photo view enter has completed")},onLeave:function(){console.log("alright, we are leaving the photo view")},onLeaveCompleted:function(){}}),l=Barba.BaseView.extend({namespace:"art",onEnter:function(){console.log("alright, the art view is ready"),n(this.namespace),$(".grid").masonry({percentPosition:!0,gutter:30})},onEnterCompleted:function(){console.log("alright, the art view enter has completed")},onLeave:function(){console.log("alright, we are leaving the art view")},onLeaveCompleted:function(){}});o.init(),l.init(),a.init(),i.init(),t.init(),Barba.Pjax.start()});